...
public interface Api {
    ...
    String WALLET_GOOD_REMOVE =Config.getOpenNewApi() + "/device/removeelecfence";
    int WALLET_GOOD_REMOVE_ID = 10012;
    ...
    /******查询会员挖矿统计数据******/
    String GET_UNMODEL_BOX = Config.DEVELOPMENT_PUBLIC_SERVER_URL + "/mining/getMemberMiningData";
    int GET_UNMODEL_BOX_ID = 100072;

    /******激活******/
    String GET_ACTIVE_BOX = Config.DEVELOPMENT_PUBLIC_SERVER_URL + "/mining/activeMemberMining";
    int GET_ACTIVE_BOX_ID = 100073;

    /******资产流水******/
    String GETRECORD_BOX = Config.DEVELOPMENT_PUBLIC_SERVER_URL+ "/mining/getBoxAssetsRecordList";
    int GETRECORD_BOX_ID = 100074;

    /******挖矿明细******/
    String MINING_BOX = Config.DEVELOPMENT_PUBLIC_SERVER_URL+ "/mining/getBoxMiningRecordList";
    int MINING_BOX_ID = 100075;

    /******地址******/
    String MINING_ADDRESS_BOX = Config.DEVELOPMENT_PUBLIC_SERVER_URL+ "/mining/getMemberCoinTypeAddressData";
    int MINING_ADDRESS_ID = 100076;

    /******提币******/
    String MINING_WITH_BOX = Config.DEVELOPMENT_PUBLIC_SERVER_URL + "/mining/withdraw";
    int MINING_WITH_BOX_ID = 100078;

    /******余额******/
    String MINING_BAL_BOX = Config.DEVELOPMENT_PUBLIC_SERVER_URL + "/mining/getMemberBalance";
    int MINING_BAL_BOX_ID = 100079;

    /******余额******/
    String MINING_DDL_BOX = Config.DEVELOPMENT_PUBLIC_SERVER_URL+ "/mining/getCoinTypeData";
    int MINING_DDL_BOX_ID = 100080;

    //查看物流
    String PAY_REMOVE_ACTIVE = Config.DEVELOPMENT_PUBLIC_SERVER_URL + "/mining/getMemberActiveData";
    int PAY_REMOVE_ACTIVE_ID = 20023;


    String PAY_CHANCE_BOX = Config.DEVELOPMENT_PUBLIC_SERVER_URL + "/mining/getBoxManageData";
    int PAY_CHANCE_BOX_ID = 20029;

    //理财列表
    String LIST_CHANCE_BOX = Config.DEVELOPMENT_PUBLIC_SERVER_URL + "/mining/getMemberManageListData";
    int LIST_CHANCE_BOX_ID = 20030;

    //理财下单
    String LIST_MEMBER_BOX = Config.DEVELOPMENT_PUBLIC_SERVER_URL + "/mining/saveMemberMamageData";
    int LIST_MEMBER_BOX_ID = 20031;

    //理财收益明细
    String FITL_MEMBER_BOX = Config.DEVELOPMENT_PUBLIC_SERVER_URL + "/mining/getMemberManageProfitListData";
    int FITL_MEMBER_BOX_ID = 20032;

    //理财赎回
    String REDE_MEMBER_BOX = Config.DEVELOPMENT_PUBLIC_SERVER_URL+ "/mining/redeemMemberMamageData";
    int REDE_MEMBER_BOX_ID = 20033;


    //兑换
    String REDE_MEMBER_USDT = Config.DEVELOPMENT_PUBLIC_SERVER_URL+ "/mining/memberCoinTypeExchange";
    int REDE_MEMBER_USDT_ID = 20034;

    //兑换
    String REDE_BLANCE_USDT = Config.DEVELOPMENT_PUBLIC_SERVER_URL+ "/hgc/getHgcAllowanceBalance";
    int REDE_BLANCE_USDT_ID = 20035;

    //兑换
    String REDE_BLANCE_RECORD = Config.DEVELOPMENT_PUBLIC_SERVER_URL+ "/hgc/getHgcAssetsRecordList";
    int REDE_BLANCE_RECORD_ID = 20036;

    //兑换
    String REDE_DRAW_RECORD = Config.DEVELOPMENT_PUBLIC_SERVER_URL+ "/hgc/withdraw";
    int REDE_DRAW_RECORD_ID = 20037;


    /*****************以下接口废弃***********************/
    //社区
    String REDE_REPORT_BOX = Config.DEVELOPMENT_PUBLIC_SERVER_URL + "/mining/getTeamReportData";
    int REDE_REPORT_BOX_ID = 20034;
   ...
   //会理财列表
    ...
    String REDE_LIST_RECORD = Config.DEVELOPMENT_PUBLIC_SERVER_URL+ "/finance/getFinanceRecordList";
    int REDE_LIST_RECORD_ID = 30001;

    //购买理财
    String REDE_LIST_BUY = Config.DEVELOPMENT_PUBLIC_SERVER_URL+ "/finance/buyFinance";
    int REDE_LIST_BUY_ID = 30002;
    //购买理财
    String REDE_LIST_DET = Config.DEVELOPMENT_PUBLIC_SERVER_URL+ "/finance/getFinanceDetail";
    int REDE_LIST_DETY_ID = 30003;

    //购买理财
    String REDE_LIST_PROF = Config.DEVELOPMENT_PUBLIC_SERVER_URL+ "/finance/getMemberProfitRecordList";
    int REDE_LIST_PROF_ID = 30004;
    //购买理财
    String REDE_LIST_PROF1 = Config.DEVELOPMENT_PUBLIC_SERVER_URL+ "/finance/getMemberFinanceRecordList";
    int REDE_LIST_PROF1_ID = 30005;

    //购买理财
    String REDE_LIST_FINANCE = Config.DEVELOPMENT_PUBLIC_SERVER_URL+ "/finance/redeemFinance";
    int REDE_LIST_FINANCE1_ID = 30006;
