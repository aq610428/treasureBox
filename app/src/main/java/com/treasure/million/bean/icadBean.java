...
public class icadBean implements Serializable {
    ...
    private String month_payurl;

    public String getMonth_payurl() {
        return month_payurl;
    }

    public void setMonth_payurl(String month_payurl) {
        this.month_payurl = month_payurl;
    }

    public String getYear_payurl() {
        return year_payurl;
    }

    public void setYear_payurl(String year_payurl) {
        this.year_payurl = year_payurl;
    }

    private String year_payurl;
