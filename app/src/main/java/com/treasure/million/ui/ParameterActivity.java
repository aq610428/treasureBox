...
import com.treasure.million.bean.LocationVO;
import com.treasure.million.bean.OdbAndLocationVO;
import com.treasure.million.bean.OdbVO;
    ...
    private void updateView(OdbAndLocationVO vo) {
        ...
        if(null != vo.getObddata()) {
            ...
            if(!Utility.isEmpty(odbVO.getControl_module_voltage())){
                parameter14Id.setText(BigDecimalUtils.round(new BigDecimal(odbVO.getControl_module_voltage()),2).toPlainString() + "V");//absolute_pressure_intake_manifold
            }
