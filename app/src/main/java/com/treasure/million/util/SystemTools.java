...
public final class SystemTools {
    ...
    public static void installApk(Activity activity, File file) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            Uri contentUri = FileProvider.getUriForFile(activity, "com.treasure.million.provider", file);
    ...
    public static void shareImg(ImageView icon_code, Activity activity) {
        ...
        if (file != null) {
            ...
            Uri uri = FileProvider.getUriForFile(activity, "com.treasure.million.provider", file);
